...
function BuyOrders({ orderbook }: Props) {
      ...
      <div className="box">
        <div className='box-title box-vertical-padding box-horizontal-padding no-select'>
          <div className='flex flex-center flex-space-between'>
            <p>&nbsp;&nbsp; <span className="gray-font">{orderbook.currency_1} / {orderbook.currency_2}&nbsp;&nbsp;</span><span className="green-font">&rarr; Bids</span></p>
          </div>
        </div>
