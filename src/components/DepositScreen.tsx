...
function DepositScreen() {
  ...
  const handlePayment = (e) => {
    ...
    e.preventDefault();
    fetch('http://127.0.0.1:8000/deposit-fiat/', {
      method: 'POST',
      headers: {
    ...
    .then(response => { 
      if (response.ok){
        ...
        alert("Error! Check details below.")
  ...
  const handleRequestFund = (e) => {
    e.preventDefault();
    fetch('http://127.0.0.1:8000/request-crypto-fund/', {
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer '+user.token,
      },
    ...
    .then(response => {
      if (response.ok) {
        alert("Request accepted and Added to your account.")
        return null;
      } else {
        alert("Error! Check details below.")
        return response.json();
    ...
    <>
      <div className='flex'>
        ...
        <div className='content full-height flex-1'>
          <Header icon='sort' title='Deposit Asset' />
          <br /><br />
          <div className="box">
                  ...
                  <div className='form-elements'>
                    <div className='form-line'>
                      <div className='full-width'>
                        <label htmlFor='view'>Select Provider</label>
                  ...
                  <div className='form-elements'>
                    <div className='form-line'>
                      <div className='full-width'>
                        ...
                        <input type='text' name='amount' id='amount' value={formValue.amount} placeholder='Enter the amount you want to deposit' onChange={handleChange} />
                      </div>
                    </div>
                  </div>
                  {error1.amount && <p className="center red">*Amount: {error1.amount}</p>}
                  <br />
                  <button type='button' className='button button-purple button-medium button-block' onClick={handlePayment}>
                    Virtual Payment
                  </button>
                </form>
            ...
            {tab === 1 && (
              <div className='box-content box-horizontal-padding box-vertical-padding box-content-height-nobutton'>
                ...
                <div className='box-text box-horizontal-padding center'>
                  <p>
                    <strong className="blue-font">Fund Will Be Allocated To You and <br />Will Be Added To Your Account Balance</strong><br /><p className="brown-font">(Only Once)</p>
                  </p>
                  <br />
                  <p>
                    <span>Fund Amount : </span>
                    <strong>100.00 ETH</strong>
                    {/* <div className='icon cover' style={{ backgroundImage: "url('https://icons.iconarchive.com/icons/cjdowner/cryptocurrency-flat/1024/Ethereum-ETH-icon.png')" }} /> */}
                  </p>
                </div>
                {error2 !== '' ? <p className="center red">*{error2}</p> : <br/>}
                <br />
                <button type='button' className='button button-purple button-medium button-block' onClick={handleRequestFund}>
                  Request Fund
                </button>
              </div>
            )}
